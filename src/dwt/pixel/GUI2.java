...
public class GUI2 extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jLabel2.setText("Enter value of N");

		jLabel1.setText("Enter value of Secret");

		jLabel3.setText("Shamir Secret Sharing");

		jButton2.setText("Make Secret Shares");
		...
		jButton4.setText("Reconstruct Original Image");
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
		...
		try{
			...
			String secret = jTextField2.getText();
			

			int k = 3;
			int n =  Integer.parseInt(n1);
			int Secret = Integer.parseInt(secret);

			System.out.println("sss N:"+n);
			System.out.println("sss:"+Secret);

			inFile = inFile.replace("\\", "\\\\");
			System.out.println("GUI "+inFile);

			String outFile = jTextField4.getText();
			outFile = outFile.replace("\\", "\\\\");
			System.out.println(outFile);

			// Calling Shamir Secret Sharing
			
			TestShamir.MakeShares(inFile,outFile, k, n, Secret);
	...
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
		...
		try{
			...
			TestShamir.reconstructImage(inFile,outFile, k, n, Secret);
